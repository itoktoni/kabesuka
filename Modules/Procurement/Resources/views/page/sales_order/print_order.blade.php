					...
					<div style="margin-top: 20px;">
						<table border='0.4' cellpadding='5' cellspacing='0' id='templateList' width='100%'>
							...
							<tr>
								...
								<td align='left' colspan='5' valign='top'>
									{{ SalesStatus::getDescription($master->so_status) ?? '' }}
								</td>
							</tr>
							<tr>
								<td align='left' colspan='3' valign='top'>
							...
							<tr>
								...
								<td align='left' colspan='5' valign='top'>
									{{ date_format(date_create($master->so_date),"d F Y") ?? '' }}
								</td>
							</tr>
							...
							<tr>
								...
								<td align='right' colspan='1' valign='middle'>
									<span>{{ $item->so_detail_qty ?? '' }}</span>
								</td>
								<td align='right' colspan='1' valign='middle'>
									<span>{{ number_format($item->so_detail_price) ?? '' }}</span>
								</td>
								<td align='right' colspan='1' valign='middle'>
									<span>{{ number_format($item->so_detail_total) ?? '' }}</span>
								</td>
							</tr>
							@endforeach
							<tr>
								...
								<td align='right' colspan='1' valign='middle'>
									...
									{{ Helper::createRupiah($master->has_detail->sum('so_detail_total')) ?? '' }}
