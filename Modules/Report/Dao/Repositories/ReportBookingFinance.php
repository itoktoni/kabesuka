...
class ReportBookingFinance extends BookingRepository implements FromView, WithColumnFormatting, WithColumnWidths, GenerateReport
{
    public $name;
    ...
    {
        $query = $this->dataRepository()->with(['has_member'])->filter();
