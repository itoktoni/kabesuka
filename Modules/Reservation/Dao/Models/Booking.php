...
class Booking extends Model
{
    ...
    public $datatable = [
        ...
        'booking_email' => [true => 'Name'],
        'booking_phone' => [true => 'Name'],
        'booking_dewasa_qty' => [true => 'Payment'],
        'booking_anak_qty' => [true => 'Payment'],
        'booking_lansia_qty' => [true => 'Payment'],
        'booking_value' => [true => 'Payment'],
        'booking_metode' => [true => 'Payment'],
        'booking_discount_value' => [true => 'Payment'],
