    ...
    <div id='page'>
        ...
        <div>
            <h3 style="text-align: center;margin-top:0px;margin-bottom:0px;">
                INV : {{ $master->booking_code ?? '' }}
            </h3>
        </div>

        <hr style="border:none;border-top: dotted 1px;">

        <img id="logo" style="width:80px;margin-left:80px;margin-bottom:-20px;margin-top:0px;padding-top:20px" src="{{ public_path('files/logo/qris.png') }}" alt="">
        ...
        <h4 style="text-align: center;margin-top:-20px;">NMID : {{ $master->booking_qris_nmid }}</h4>
