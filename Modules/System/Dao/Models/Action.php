...
use Modules\System\Dao\Enums\ShowStatus;
...
class Action extends Model
{
    ...
    public function mask_show()
    {
        return 'system_action_show';
    }

    public function setMaskShowAttribute($value)
    {
        $this->attributes[$this->mask_show()] = $value;
    }

    public function getMaskShowAttribute()
    {
        return $this->{$this->mask_show()};
    }
    
    public function getMaskShowName($value)
    {
        return ShowStatus::getDescription($this->mask_show);
    }

    //mask api

    public function mask_api()
    {
        return 'system_action_api';
    }

    public function setMaskApiAttribute($value)
    {
        $this->attributes[$this->mask_api()] = $value;
    }

    public function getMaskApiAttribute()
    {
        return $this->{$this->mask_api()};
    }
    
    public function getMaskApiName($value)
    {
        return ActiveStatus::getDescription($this->mask_api);
    }
}
